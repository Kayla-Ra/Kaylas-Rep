function equivalentCheck(){//This allow th last value to remain in view until other button are pressed.
...
function input(x) {
    ...
    if (document.getElementById("decimalVar").value == 0)
    {
        ...
        if (decimalCount == 1){
            ...
            document.getElementById("result").value += x;//append the value maybe
        }
...
function decimalpoint(){
    ...
    if (parseInt(document.getElementById("operation").value)){ //if this is a empty string, it will return false.
        document.getElementById("result").value = 0;
    }
}
...
function operandCheck(){
    if (document.getElementById("operand").value == ""){
        ...
        document.getElementById("result").value = "cats ^..^ thinking"; //adds cats when calculating
...
function allclear(){
    ...
    document.getElementById("operand").value = "";
    document.getElementById("equivalent").value = 0;
    document.getElementById("decimalVar").value = 0; //confusing trying to clear decimal point, kayla code
